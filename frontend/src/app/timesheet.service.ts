...
export class TimesheetService {
  ...
  getStudents(appUser: string, year: number, month: number): Observable<Timesheet[]>{
      return this.http.get<Timesheet[]>(this.url+'timesheets/user/'+appUser+'/'+year+"/"+month);
  };
  ...
  postNewStudent(studentData): Observable<string>{
     ...
     body.append('appUser', sessionStorage.getItem('appUser'));
     ...
     body.append('appPassword', studentData.studentPassword);
     body.append('isStudent', studentData.isStudent);
