...
public class StudentController {
    ...
    @Autowired UserDBRepository userDBRepository;
    ...
    public ResponseEntity postStudent(@RequestParam String appUser, @RequestParam String firstName, @RequestParam String lastName, @RequestParam String userName,@RequestParam String appPassword , @RequestParam String isStudent, @RequestParam String loginUserName, @RequestParam String password) {
        ...
        if(userDBRepository.userIsStudent(appUser)){
            return ResponseEntity.status(400).contentType(TEXT_PLAIN).body("User is not authorized");
        }
        ...
        userDBRepository.addUser(userName, appPassword, Boolean.parseBoolean(isStudent));
    ...
    public ResponseEntity deleteStudent(@PathVariable String userName) {
        ...
        userDBRepository.deleteUser(userName);
